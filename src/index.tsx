...
const createWindow = (): void => {
  ...
  function updateLogEntry(arg: packets.Universal) {
    const send: packets.Send | undefined = packets.FillSend(arg)
    if (send) {
  ...
  // for testing, use localhost or knotfree.dog (which is 127.0.0.1 in my /etc/hosts file)
  // host = "knotfree.dog" // "localhost"
  ...
  console.log("startHttpProxy happened with host", host, "and config", serverListConfig.toString())
