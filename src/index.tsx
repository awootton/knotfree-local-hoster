...
import * as subscriber from "./startPacketSubscription"
...
//   console.log("upDateTestTopic needs override", arg.toString())
// }

// var mainProcessServerListConfig: types.ServerConfigList = types.EmptyServerConfigList
...
const createWindow = (): void => {
  ...
  var updateTestTopic = (arg: packets.Universal) => {
    // console.log("upDateTestTopic", arg.toString())
  ...
  subscriber.startTestTopicWatcher(updateTestTopic,host)
  ...
  // or localhost 
  const gadget = http.startHttpProxy(serverListConfig,host,8384)
