...
function App(): ReactElement {
    ...
    return (
        <div className="likeTypography" >
            ...
            Add access token here (you can get one from https://knotfree.net/ in the "ACCESS TOKEN" section
            and don't forget to supply a passphrase and copy out both the public key and the generated token and save them).
            <input
